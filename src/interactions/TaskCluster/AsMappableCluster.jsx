...
const statusIcons = _fromPairs(
  _map(TaskStatusColors, (color, status) => [
    status,
    L.vectorIcon({
...
export class AsMappableCluster {
  ...
  leafletMarkerIcon(
    ...
    if (count > 1) {
      ...
      const isSelected =
        !!selectedClusters && !!_find(selectedClusters, { clusterId: clusterData.clusterId });
