...
import { challengeSchema, receiveChallenges, fetchChallenges } from "../Challenge/Challenge";
import { taskSchema, taskDenormalizationSchema, receiveTasks } from "../Task/Task";
          ...
          properties: Object.assign({}, _get(oldUser, "properties"), {
            [appId]: {
              ...
              settings: Object.assign(
                {},
                _get(oldUser, `properties.${appId}.settings`),
                appSetting,
              ),
            },
          }),
