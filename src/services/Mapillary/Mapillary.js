...
export const isMapillaryEnabled = function() {
  return !_isEmpty(process.env.REACT_APP_MAPILLARY_CLIENT_TOKEN)
}
...
export const fetchMapillaryImages = async function(bbox, point=null, radius=250, lookAt=false, pageSize=100) {
  ...
  try {
    ...
    params.push(`access_token=${process.env.REACT_APP_MAPILLARY_CLIENT_TOKEN}`)
...
export const getAccessToken = function() {
  return process.env.REACT_APP_MAPILLARY_CLIENT_TOKEN
}
