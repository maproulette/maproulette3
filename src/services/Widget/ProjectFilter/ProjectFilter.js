...
export const projectPassesFilters = function (project, manager, pins, projectFilters) {
  ...
  if (Boolean(projectFilters.archived) !== Boolean(project.isArchived)) {
    return false;
  }
