  ...
  render() {
    ...
    const projectSearchBox = (
      <SearchBox
        ...
        searchQuery={{
          query: _get(this.state.searchQuery, `${this.props.reviewTasksType}.project`),
        }}
      />
    );
    ...
    const challengeSearchBox = (
      <SearchBox
        ...
        searchQuery={{
          query: _get(this.state.searchQuery, `${this.props.reviewTasksType}.challenge`),
        }}
      />
    );
