...
export default class ReviewStats extends Component {
  ...
  render() {
    ...
    if (!!this.props.asReviewer && _get(this.props.reviewMetrics, "avgReviewTime", 0) > 0) {
