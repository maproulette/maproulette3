      ...
      return (
        <p>
          ...
          <span className="mr-ml-1 mr-font-bold mr-text-pink">
            <FormattedMessage {...messages.completedTasks} values={{ completedTasks }} />
          </span>
          <FormattedMessage {...messages.pointsPrompt} />
          <span className="mr-ml-1 mr-font-bold mr-text-pink">
            <FormattedMessage {...messages.points} values={{ points: userScore }} />
          </span>
            ...
            {_isFinite(latestChallenge) ? (
              <Fragment>
                <div className="mr-flex mr-items-center mr-mr-8">
                  ...
                  <div>
                    <Link to={`/browse/challenges/${latestChallenge}`} className="mr-button">
