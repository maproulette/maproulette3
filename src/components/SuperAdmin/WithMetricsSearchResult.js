 ...
 *        itemsProp.
 */
export const WithMetricsSearchResult= function(WrappedComponent, searchName,
  ...
  return class extends Component {
    ...
    render() {
      console.log(searchName, itemsProp, outputProp)
      ...
      console.log(outputProp, searchResults)
