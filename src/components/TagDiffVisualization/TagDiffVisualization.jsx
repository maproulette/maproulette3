...
export class TagDiffVisualization extends Component {
  ...
  render() {
    ...
    if (this.props.onlyChanges && (this.props.hasTagChanges === false || tagChanges.length === 0)) {
      return (
    ...
    const tagNames = tagChanges.map((change) => (
      ...
      >
        {changeSymbol(change)}{" "}
        <div className="mr-flex-shrink-1 mr-overflow-x-hidden mr-truncate" title={change.name}>
          {change.name}
        </div>
      </li>
    ));
    tagNames.unshift(
      <li key="name_header" className="mr-font-bold mr-pb-1 mr-h-6">
        &nbsp;
      </li>,
    );
    ...
    newValues.unshift(
      <li
        key="newvalue_header"
        className="mr-text-base mr-font-bold mr-pb-1 mr-pl-2 mr-flex mr-h-6"
      >
      ...
      <div>
        ...
        {this.state.editing && (
          <div className="mr-flex mr-justify-end">
            ...
            <button className="mr-button mr-button--white" onClick={() => this.cancelEdits()}>
...
export const changeSymbol = (change) => {
  ...
  switch (change.status) {
    case "changed":
      changeSymbol = (
        <div className="mr-min-w-5 mr-mr-1 mr-flex-shrink-0 mr-text-orange mr-text-lg mr-font-bold">
          &Delta;
        </div>
      );
      break;
    case "removed":
      changeSymbol = (
        <div className="mr-min-w-5 mr-mr-1 mr-flex-shrink-0 mr-text-lavender-rose mr-text-lg mr-font-bold">
          &mdash;
        </div>
      );
      break;
    case "added":
      changeSymbol = (
        <div className="mr-min-w-5 mr-mr-1 mr-flex-shrink-0 mr-text-picton-blue mr-text-3xl mr-leading-none">
          +
        </div>
      );
      break;
...
export const AddTagControl = (props) => {
  if (!props.addingTag) {
    return (
      <button className="mr-button mr-button--xsmall" onClick={props.beginAddingTag}>
