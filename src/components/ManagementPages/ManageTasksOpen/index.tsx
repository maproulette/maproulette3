      ...
      <div className="mx-auto max-w-xl px-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter a task ID below. You can find task IDs when working on a task (URL or header)
              or from your saved/locked tasks on the dashboard.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <p className="mt-6 text-sm text-zinc-500 dark:text-zinc-400">
          Or go to <Link to="/manage/projects" className="text-blue-600 hover:underline dark:text-blue-400">Projects</Link> or{' '}
          <Link to="/manage/challenges" className="text-blue-600 hover:underline dark:text-blue-400">Challenges</Link> to find
          a challenge, then browse it to open a task and get its ID from the URL.
        </p>
      </div>
      </SuperAdminGuard>
    </AuthGuard>
