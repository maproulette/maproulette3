...
export class SearchTypeFilter extends Component {
  ...
  render() {
    const localizedSearchTypeLabels = {
      [SEARCH_TYPE_TASK]: this.props.intl.formatMessage(messages.searchTypeTask),
      [SEARCH_TYPE_CHALLENGE]: this.props.intl.formatMessage(messages.searchTypeChallenge),
      [SEARCH_TYPE_PROJECT]: this.props.intl.formatMessage(messages.searchTypeProject),
    };
