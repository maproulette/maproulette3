            ...
            <div className="mr-flex mr-items-center">
              ...
              <Dropdown
                ...
                dropdownContent={(dropdown) => (
                  <ProfileMenu {...this.props} closeDropdown={dropdown.closeDropdown} />
                )}
              />
            </div>
          </LoggedInUser>
  ...
  return (
    <button className="mr-dropdown__button" onClick={props.toggleDropdownVisible}>
      <span className="mr-flex mr-items-center mr-text-white">
        ...
        <span className="mr-text-sm mr-mr-1 xl:mr-mr-2">{props.user.osmProfile.displayName}</span>
        <SvgSymbol
...
const UnreadNotificationsIndicator = function (props) {
  ...
  return (
    ...
    >
      <div className="mr-text-white mr-text-xxs">{props.user.unreadNotificationCount}</div>
    </div>
  );
};
...
const MobileNav = (props) => (
  <Fragment>
    ...
    <LoggedOutUser {...props}>
      <SignInButton className="white-on-green top-nav__signin-link" {...props} />
    </LoggedOutUser>
