...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A loading spinner component that displays an animated spinner with a customizable message. Built with accessibility in mind and consistent styling for the MapRoulette 4 application.',
      },
    },
  },
  argTypes: {
...
export const LongMessage: Story = {
  args: {
    message:
      'This is a very long loading message that demonstrates how the component handles extended text content while maintaining good readability and layout.',
  },
  parameters: {
    docs: {
      description: {
...
export const InContext: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Loader component displayed within a realistic application context to show how it integrates with other UI elements.',
      },
    },
  },
};
