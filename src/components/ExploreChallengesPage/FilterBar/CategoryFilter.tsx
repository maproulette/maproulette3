    ...
    <div className="flex items-center gap-2">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="outline"
            className="h-9 w-36 justify-start border-zinc-300 font-normal dark:border-zinc-700"
          >
            {selectedCategories.length === 0 ? 'Anything' : `${selectedCategories.length} selected`}
          </Button>
        </DropdownMenuTrigger>
        <DropdownMenuContent
          align="start"
