...
export default class OpenStreetCamViewer extends Component {
  ...
  hasNextImage = () => {
    return this.state.currentIndex !== -1 && this.state.currentIndex < this.props.images.length - 1;
  };
  ...
  hasPriorImage = () => {
    return this.state.currentIndex !== -1 && this.state.currentIndex > 0;
  };
  ...
  render() {
    const currentImage =
      this.state.currentIndex === -1 ? null : this.props.images[this.state.currentIndex];
