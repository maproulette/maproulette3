...
export default class TaskPropertyFilter extends Component {
  ...
  render() {
    ...
    const areTaskPropertyFiltersActive = currentTaskPropertyFilters
      ? Object.keys(currentTaskPropertyFilters).length > 0
      : false;
        ...
        <div className="mr-dropdown mr-dropdown--right">
          ...
          >
            <span className="mr-text-base mr-uppercase mr-mr-1">
              <span>
                <FormattedMessage {...messages.filterByPropertyLabel} />
              </span>
            </span>
            <SvgSymbol
          ...
          {this.state.showForm && (
            <External>
              <Modal isActive wide onClose={() => this.setState({ showForm: false })}>
                <div className="mr-max-h-screen75">{formSearch}</div>
              </Modal>
            </External>
          )}
        </div>
