...
import { subscribeToAllTasks, unsubscribeFromAllTasks } from "../../../services/Task/Task";
...
export const Activity = (props) => {
  ...
  useEffect(() => {
    subscribeToAllTasks((message) => {
      if (
        message.messageType === "task-completed" &&
  ...
  return (
    <div>
      ...
      />
      {hasMore && (
        <button className="mr-button mr-button--small" onClick={() => setPage(page + 1)}>
