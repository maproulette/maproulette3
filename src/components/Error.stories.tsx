...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'An error display component that shows error messages with optional retry functionality. Built with accessibility in mind and consistent styling for the MapRoulette 4 application.',
      },
    },
  },
  argTypes: {
...
export const NoRetry: Story = {
  args: {
    message:
      'This action cannot be completed at this time. Please contact support if the problem persists.',
    showRetry: false,
  },
  parameters: {
    docs: {
...
export const LongMessage: Story = {
  args: {
    message:
      'This is a very long error message that demonstrates how the component handles extended text content. It should wrap properly and maintain good readability while providing comprehensive information about what went wrong and how the user might resolve the issue.',
    onRetry: fn(),
    showRetry: true,
  },
  parameters: {
  ...
  render: () => (
    <div className="space-y-8">
      <div>
        ...
        <ErrorComponent message="This error can be retried" onRetry={fn()} showRetry={true} />
      </div>

      <div>
        <h3 className="text-lg font-semibold mb-4">Without Retry Button</h3>
        <ErrorComponent message="This error cannot be retried" showRetry={false} />
      </div>
