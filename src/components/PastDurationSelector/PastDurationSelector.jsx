            ...
            return (
              <div className="mr-pt-2 mr-min-w-72 mr-overflow-hidden">
                <div className="mr-text-green-lighter mr-w-full">
                  <button
                    className="mr-absolute mr-right-0 mr-top-0 mr-mt-2"
                    onClick={() => this.setState({ showChooseCustomDates: false })}
                  >
                    <SvgSymbol
                      sym="outline-close-icon"
                      viewBox="0 0 20 20"
                ...
                {this.startDate() && this.endDate() && (
                  <button
                    className="mr-button mr-button--small mr-button--green-lighter mr-mt-2"
                    onClick={() => {
                      this.props.selectCustomRange(this.startDate(), this.endDate());
    ...
    <button className="mr-dropdown__button" onClick={props.toggleDropdownVisible}>
      <span className="mr-flex">
        <span className="mr-mr-2">
          ...
          {props.currentMonthsPast === ALL_TIME && <FormattedMessage {...messages.allTimeOption} />}
          {/* Disable until the leaderboard can handle unique params */}
