      ...
      >
        ...
        <div
          className={classNames(
            ...
            "md:mr-w-2/3 md:mr-pin-t-15 md:mr-pin-l-16": this.props.wide,
            "md:mr-min-w-1/3 md:mr-w-1/3 md:mr-pin-t-15 md:mr-pin-l-33": this.props.narrow,
        ...
        >
          <div
            className={classNames(
              'mr-relative mr-bg-blue-dark mr-p-8 mr-rounded mr-shadow mr-w-full mr-w-md mr-mx-auto mr-overflow-y-auto mr-max-h-screen80',
