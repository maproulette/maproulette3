...
export default class ChallengeOverviewWidget extends Component {
  render() {
    ...
    const dataOriginDateText =
      !this.props.challenge.dataOriginDate || !this.props.challenge.lastTaskRefresh
        ? null
          ...
          <div className="mr-flex mr-items-center">
            ...
            <div>
              {this.props.challenge.created && (
                <FormattedDate
                  value={parseISO(this.props.challenge.created)}
                  year="numeric"
                  month="long"
                  day="2-digit"
                />
          ...
          <div className="mr-flex mr-items-center">
            ...
            <div>
              {this.props.challenge.lastTaskRefresh && (
                <FormattedDate
                  value={parseISO(this.props.challenge.lastTaskRefresh)}
                  year="numeric"
                  month="long"
                  day="2-digit"
                />
