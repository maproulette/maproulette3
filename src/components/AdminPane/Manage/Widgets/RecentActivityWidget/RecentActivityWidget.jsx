...
import ChallengeActivityTimeline from "../../../../ActivityTimeline/ChallengeActivityTimeline/ChallengeActivityTimeline";
    ...
    return (
      ...
      >
        <ChallengeActivityTimeline
          activity={_takeRight(_get(this.props, "challenge.activity", []), 90)}
          maxEntries={14}
          invertBadges={false}
        />
      </QuickWidget>
