...
export default defineMessages({
  ...
  instructionDescription: {
    ...
    defaultMessage:
      "Instructions for users doing this specific task " + "(overrides challenge instructions)",
  },
  ...
  geometriesDescription: {
    ...
    defaultMessage:
      "GeoJSON for this task. Every Task in MapRoulette basically " +
  ...
  statusDescription: {
    ...
    defaultMessage:
      "Status of this task. Depending on the current " +
  ...
  additionalTagsDescription: {
    ...
    defaultMessage:
      "You can optionally provide additional " + "MR tags that can be used to annotate this task.",
  },
