...
export default class ChallengeControls extends Component {
  ...
  render() {
    ...
    const tasksNeedRebuild = handleTasksNeedRebuild(_get(this.props.challenge, "lastTaskRefresh"));
    const disableUnarchive = tasksNeedRebuild && _get(this.props.challenge, "systemArchivedAt");
          ...
          <Fragment>
            <Link
              to={{
                ...
                state: _merge(_get(this.props.searchCriteria, "filters")),
              }}
              className={this.props.controlClassName}
            >
