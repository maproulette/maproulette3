...
export const WithCurrentProject = function (WrappedComponent, options = {}) {
  return class extends Component {
    ...
    routedProjectId = (props) => parseInt(_get(props, "match.params.projectId"), 10);

    routedChallengeId = (props) => parseInt(_get(props, "match.params.challengeId"), 10);
    ...
    render() {
      ...
      const project = !_isFinite(projectId)
        ? null
