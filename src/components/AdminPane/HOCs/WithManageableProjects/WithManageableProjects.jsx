...
import { setTeamProjectRole, removeTeamFromProject } from "../../../../services/Team/Team";
...
const WithManageableProjects = function (WrappedComponent, includeChallenges = false) {
  return class extends Component {
    ...
    render() {
      ...
      const manageableProjects = manager.manageableProjects(
        _values(_get(this.props, "entities.projects")),
      );
