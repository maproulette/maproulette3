  ...
  return class extends Component {
      ...
      if (challengeId && props.fetchChallengeActions) {
        ...
        props.fetchChallengeActions(challengeId, true, criteria).then((normalizedResults) => {
          ...
          if (_get(normalizedResults, `entities.challenges.${challengeId}`)) {
            ...
            fetchedPriorityMetrics = _get(normalizedResults, "entities.challenges")[challengeId]
              .priorityActions;
          }
    ...
    componentDidUpdate(prevProps) {
      ...
      if (challengeId) {
        ...
        if (
          !_isEqual(
            _get(this.props.searchFilters, "filters"),
        ...
        if (
          !_isEqual(
            _get(this.props.searchCriteria, "filters.invertFields"),
