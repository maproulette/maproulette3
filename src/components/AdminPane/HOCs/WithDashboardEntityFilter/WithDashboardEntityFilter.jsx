 ...
 */
const WithDashboardEntityFilter = function (
  WrappedComponent,
  filterType,
  itemsProp,
  pinsProp,
  ...
  return class extends Component {
    ...
    setDashboardEntityFilter = (filterName, filterValue) => {
      ...
      this.props.saveWorkspaceConfiguration(
        Object.assign({}, this.props.currentConfiguration, { filters: updatedFilters }),
      );
    };
    ...
    toggleDashboardEntityFilter = (filterName) => {
      const existingValue = _get(
        this.props.currentConfiguration.filters,
        `${this.filterFieldName()}.${filterName}`,
        false,
      );
    ...
    render() {
      ...
      const filters = _get(this.props.currentConfiguration.filters, this.filterFieldName(), {});
