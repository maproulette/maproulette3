...
import { addWidgetToGrid, compatibleWidgetTypes } from "../../../services/Widget/Widget";
...
const WithWidgetManagement = function (WrappedComponent) {
  return class extends Component {
    ...
    availableWidgets = () => {
      ...
      const unusedWidgets = _differenceBy(
        compatibleWidgets,
    ...
    addWidget = (widgetKey) => {
      ...
      this.props.saveWorkspaceConfiguration(addWidgetToGrid(this.props.workspace, widgetKey));
    };
    ...
    removeWidget = (widgetIndex) => {
      ...
      this.props.saveWorkspaceConfiguration(
        Object.assign({}, this.props.workspace, { widgets: updatedWidgets, layout: updatedLayout }),
      );
    };
    ...
    updateWidgetConfiguration = (widgetIndex, changes) => {
      ...
      this.props.saveWorkspaceConfiguration(
        Object.assign({}, this.props.workspace, { widgets: updatedWidgets }),
      );
    };
    ...
    updateLayout = (newLayout) => {
      this.props.saveWorkspaceConfiguration(
        Object.assign({}, this.props.workspace, { layout: newLayout }),
      );
    };
