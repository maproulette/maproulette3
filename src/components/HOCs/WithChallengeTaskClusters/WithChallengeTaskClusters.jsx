...
import { fetchTaskClusters, clearTaskClusters } from "../../../services/Task/TaskClusters";
import { fetchBoundedTasks, clearBoundedTasks } from "../../../services/Task/BoundedTask";
...
export const WithChallengeTaskClusters = function (
  ...
  return class extends Component {
        ...
        this.props
          ...
          .then((results) => {
            if (currentFetchId >= this.state.fetchId) {
              ...
              if (
                results.totalCount > UNCLUSTER_THRESHOLD &&
                _get(this.props, "criteria.zoom", 0) < MAX_ZOOM
              ) {
                this.props
    ...
    componentDidUpdate(prevProps) {
      if (
        !_isEqual(_get(prevProps.criteria, "searchQuery"), _get(this.props.criteria, "searchQuery"))
      ) {
        this.debouncedFetchClusters(this.state.showAsClusters);
      } else if (
        !_isEqual(
...
export const mapDispatchToProps = (dispatch) =>
  Object.assign({}, bindActionCreators({ fetchTaskClusters, fetchBoundedTasks }, dispatch), {
