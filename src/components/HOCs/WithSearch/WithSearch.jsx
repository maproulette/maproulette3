...
import { toLatLngBounds, DEFAULT_MAP_BOUNDS } from "../../../services/MapBounds/MapBounds";
...
export const _WithSearch = function (WrappedComponent, searchGroup, searchFunction) {
  return class extends Component {
    ...
    render() {
      ...
      // searches in play.
      const searchQueries = Object.assign({}, _get(this.props, "searchQueries", {}), {
        [searchGroup]: {
      ...
      const isLoading =
        _get(this.props, `currentSearch.${searchGroup}.meta.fetchingResults`) != null;
...
export const mapStateToProps = (state, searchGroup) => {
  return {
    ...
    mapBounds: convertBounds(
      _get(state, `currentSearch.${searchGroup}.mapBounds`, { bounds: DEFAULT_MAP_BOUNDS }),
    ),
  };
};
