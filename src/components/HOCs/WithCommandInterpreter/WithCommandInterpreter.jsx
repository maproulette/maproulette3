...
const WithCommandInterpreter = function (WrappedComponent, acceptedCommands = null) {
  return class extends Component {
    ...
    componentDidUpdate(prevProps) {
      if (
        _get(prevProps, "searchQuery.filters.searchType") !==
        ...
        if (this.state.commandString) {
          ...
          this.setState({
            commandString: _get(this.props, "searchQuery.filters.project"),
            searchType: _get(this.props, "searchQuery.filters.searchType"),
          });
        } else {
          // Happens when task query is on url route
          this.setState({
            commandString: _get(this.props, "searchQuery.filters.task"),
            searchType: _get(this.props, "searchQuery.filters.searchType"),
          });
        }
      }
