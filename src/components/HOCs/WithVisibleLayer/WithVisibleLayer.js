...
import { layerSourceWithId, defaultLayerSource } from "../../../services/VisibleLayer/LayerSources";
...
export const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    changeLayer: (layerId, mapType = null) => {
      ...
      const challengeId = isVirtual ? ownProps.virtualChallengeId : _get(ownProps, "challenge.id");
