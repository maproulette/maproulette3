...
export default function (
  ...
  defaultShowColumns = [],
  columnMessages,
  appSettingName = "adminChallengeColumns",
  idPath = "challenge.id",
  ...
  class WithConfigurableColumns extends Component {
    ...
    resetColumnChoices = (allColumns, defaultColumns) => {
      ...
      if (this.props.getUserAppSetting(this.props.user, appSettingName)) {
        ...
        addedColumnsKeys = this.props.getUserAppSetting(this.props.user, appSettingName)[id];
    ...
    addColumn = (columnKey) => {
      ...
      this.setState({
        availableColumns: _omit(this.state.availableColumns, columnKey),
