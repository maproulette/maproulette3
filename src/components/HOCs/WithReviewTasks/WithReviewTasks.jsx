...
export const WithReviewTasks = function (WrappedComponent) {
  return class extends Component {
    ...
    update(props, criteria, skipURLUpdate = false) {
      ...
      const pageSize =
        _get(this.state.criteria[props.reviewTasksType], "pageSize") || DEFAULT_PAGE_SIZE;
      ...
      if (_isUndefined(searchOnCriteria.savedChallengesOnly)) {
        searchOnCriteria.savedChallengesOnly = _get(
      ...
      if (_isUndefined(searchOnCriteria.excludeOtherReviewers)) {
        ...
        searchOnCriteria.excludeOtherReviewers = _get(
          this.state.criteria[this.props.reviewTasksType],
    ...
    render() {
      ...
      const criteria =
        this.state.criteria[this.props.reviewTasksType] || this.buildDefaultCriteria(this.props);
      const projectId = _get(this.state.criteria[this.props.reviewTasksType], "filters.projectId");
