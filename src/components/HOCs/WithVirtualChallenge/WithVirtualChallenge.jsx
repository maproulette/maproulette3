...
export const mapStateToProps = (state, ownProps) => {
  ...
  if (_isFinite(virtualChallengeId)) {
    ...
    mappedProps.virtualChallenge = _get(state, `entities.virtualChallenges.${virtualChallengeId}`);
  }
...
export const virtualChallengeIdFromRoute = (props, defaultId) => {
  const virtualChallengeId = parseInt(_get(props, "match.params.virtualChallengeId"), 10);
