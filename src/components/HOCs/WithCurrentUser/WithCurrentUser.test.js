...
import { mapDispatchToProps, mapStateToProps } from "./WithCurrentUser";
...
test("mapStateToProps provides the current user in denormalized form", () => {
  ...
  expect(denormalize).toBeCalledWith(
    basicState.entities.users[basicState.currentUser.userId],
    schema,
    basicState.entities,
  );
