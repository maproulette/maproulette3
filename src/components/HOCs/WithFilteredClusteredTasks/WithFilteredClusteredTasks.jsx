...
export default function WithFilteredClusteredTasks(
  ...
  return class extends Component {
    defaultFilters = () => {
      return {
        includeStatuses:
          initialFilters?.statuses ?? _fromPairs(_map(TaskStatus, (status) => [status, true])),
        includeReviewStatuses:
          initialFilters?.reviewStatuses ??
          _fromPairs(_map(TaskReviewStatusWithUnset, (status) => [status, true])),
        includeMetaReviewStatuses:
          initialFilters?.metaReviewStatuses ??
    ...
    componentDidUpdate(prevProps) {
      if (
        !_isEqual(prevProps[tasksProp]?.tasks, this.props[tasksProp]?.tasks) ||
