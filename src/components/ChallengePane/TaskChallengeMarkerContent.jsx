...
class TaskChallengeMarkerContent extends Component {
  render() {
    ...
    let challengeId = markerData.options.parentId || _get(this.props.task, "parent.id");
    if (!challengeId && _get(markerData.options, "challengeIds.length", 0) === 1) {
        ...
        <h3>
          <div className="mr-text-left mr-text-grey">
            ...
            <div className="mr-text-sm">
              ...
              {markerData.options.name || _get(this.props.task, "name")}
              <br />
              ...
              >
                {markerData.options.id || _get(this.props.task, "id")}
              </a>
              <br />
              ...
              <a onClick={() => this.props.history.push(`/browse/challenges/${challengeId}`)}>
                {markerData.options.parentId || _get(this.props.task, "parent.id")}
              </a>
            </div>
          </div>
        </h3>
