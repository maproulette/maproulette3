...
export class BasicDialog extends Component {
  render() {
    return (
      <Modal isActive {...this.props.modalProps} fullBleed onClose={this.props.onClose}>
        <article>
          {this.props.icon && (
          ...
          <div className="mr-flex mr-flex-col mr-items-center mr-px-8 mr-pt-12">
            ...
            {this.props.title && (
              <div className="mr-text-3xl mr-mb-4 mr-text-grey-light">{this.props.title}</div>
            )}
            {this.props.prompt && (
              <div className="mr-font-medium mr-text-grey-light">{this.props.prompt}</div>
            )}
          </div>
