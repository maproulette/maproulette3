...
export class ZoomInMessage extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps.zoom < this.props.zoom && prevProps.zoom <= MIN_ZOOM && !this.state.minimized) {
      this.setState({ minimized: true });
    }
    // If user has zoomed out then we want to un-minimize
    else if (
      prevProps.zoom > this.props.zoom &&
      this.props.zoom <= MIN_ZOOM &&
      ...
      <div className="mr-absolute mr-top-0 mr-mt-3 mr-w-full mr-flex mr-justify-center">
        <div className="mr-z-5 mr-flex-col mr-items-center mr-bg-blue-dark-50 mr-text-white mr-rounded">
          <div className="mr-py-2 mr-px-3 mr-text-center">
            ...
            <div
              className="mr-pl-8 mr-inline-block"
                ...
                <button
                  ...
                  onClick={() => {
                    this.props.setSearchFilters({
                      location: ChallengeLocation.intersectingMapBounds,
                    });
