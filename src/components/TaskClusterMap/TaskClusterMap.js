  ...
  useEffect(() => {
    ...
    return (
      <MapContainer
        ...
        {props.showScaleControl && <ScaleControl className="mr-z-10" position='bottomleft'/>}
        {props.showFitWorld && <FitWorldControl />}
        {props.taskCenter &&
          <FitBoundsControl key={props.taskCenter.toString()} centerPoint={props.taskCenter} />
        }
        ...
        {!!props.showTaskCount && displayTaskCount && !props.mapZoomedOut &&
