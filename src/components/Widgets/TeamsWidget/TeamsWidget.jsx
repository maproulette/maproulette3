...
const TeamsWidget = (props) => {
  ...
  if (editingTeam) {
    currentView = <EditTeam {...props} team={editingTeam} finish={() => setEditingTeam(null)} />;

    widgetTitle = _isEmpty(editingTeam) ? messages.createTeamTitle : messages.editTeamTitle;
  } else if (viewingTeam) {
      ...
      <Dropdown
        ...
        dropdownContent={() => (
          <ul className="mr-list-dropdown">
            <li>
              <button className="mr-text-current" onClick={() => setEditingTeam({})}>
