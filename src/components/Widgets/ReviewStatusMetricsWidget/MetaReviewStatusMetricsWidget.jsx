...
const descriptor = {
  ...
  targets:
    window.env.REACT_APP_FEATURE_META_QC === "enabled"
      ? [WidgetDataTarget.review, WidgetDataTarget.challenge, WidgetDataTarget.challenges]
      : [],
  minWidth: 2,
  defaultWidth: 4,
  minHeight: 4,
  ...
  render() {
    ...
    return (
      <QuickWidget
        {...this.props}
        className=""
        widgetTitle={<FormattedMessage {...messages.metaReviewStatusTitle} />}
        noMain
      >
...
MetaReviewStatusMetricsWidget.hideWidget = function () {
  return window.env.REACT_APP_FEATURE_META_QC !== "enabled";
};
