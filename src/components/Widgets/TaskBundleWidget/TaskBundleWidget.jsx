...
export default class TaskBundleWidget extends Component {
  ...
  setBoundsToNearbyTask = () => {
    ...
    this.updateBounds(this.props.challengeId, nearbyBounds, _get(this.props, "mapBounds.zoom", 18));
  };
...
const ActiveBundle = (props) => {
  ...
  const table = (
    <TaskAnalysisTable
      ...
      taskData={
        props.bundledOnly && props.taskBundle
          ? _get(props, "taskBundle.tasks")
          : _get(props, "taskInfo.tasks")
      }
