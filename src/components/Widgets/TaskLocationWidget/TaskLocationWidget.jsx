...
export default class TaskLocationWidget extends Component {
  ...
  render() {
    ...
    return (
          ...
          <>
            ...
            {reverseLonLat ? (
              <button
                ...
                onClick={() => this.toggleReverseLonLat(reverseLonLat)}
              >
      ...
      >
        <div className="mr-mt-5" style={{ height: "calc(100% - 6rem)" }}>
          <MapPane {...this.props}>
            <TaskLocationMap
        ...
        <PlaceDescription address={this.props.task.place?.address} className="mr-text-xs mr-mt-4" />
